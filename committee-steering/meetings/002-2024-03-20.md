...
- Are we prepping the Marketplace for NFTs from other chains, or just adding it to roadmap for future?
  ...
  - We've seen some unique opportunities with Ethereum layer 2s and other Cosmos chains that we've talked about (e.g, having Stargaze outpost on Passage right). There's clear interoperability and interchain opportunities, it's just figuring out the value it would being to the Passage community 
